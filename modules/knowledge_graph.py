"""
Knowledge Graph Module for R2Gen (v6 — revert to hardcoded entities)

The BiomedCLIP-based dynamic node discovery (v5: unigram-first extraction +
confidence-thresholded typing) hurt report-generation quality relative to the
original hardcoded entity lists, so this reverts KnowledgeGraphBuilder and
KnowledgeGraphEncoder to the v2 design (see commit "clean up"). No BiomedCLIP
dependency remains in this module.
